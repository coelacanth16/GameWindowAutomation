namespace GameWindowAutomation.WindowScrape
{
    using System;
    ...
    internal static class HwndInterface
    {
        ...
        {
            var lpRect = new GameWindowAutomation.WindowScrape.RECT();
        ...
        [DllImport("user32.dll")]
        private static extern bool GetWindowRect(IntPtr hWnd, out GameWindowAutomation.WindowScrape.RECT lpRect);
